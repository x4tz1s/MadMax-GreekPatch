...
1. Κατέβασε το πρόγραμμα από τα [Releases](../../releases) (`MadMaxGreekPatcher_v1.0.2_Windows.zip`) και αποσυμπίεσέ το σε έναν φάκελο.
...
Κατέβασε το `MadMaxGreekPatcher_v1.0.2_Linux.tar.gz`, βγάλ' το, βάλε δίπλα το φάκελο `Data` και τρέξε `./MadMaxGreekPatcher`
